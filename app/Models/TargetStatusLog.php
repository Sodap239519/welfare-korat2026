...
{
    protected $fillable = ['target_id', 'status_code', 'sub_status_code', 'submitter_role', 'submitter_name', 'channel_id', 'sub_channel', 'note', 'user_id', 'user_name_snapshot', 'changed_at'];
